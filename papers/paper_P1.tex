...
\noindent\textbf{Word count:} approximately 6{,}300 words.
...
anywhere else we could locate (in particular not in the annotated
bibliographies of Lagarias). The bound is a routine consequence of the
present framework, and we state it with that caveat. (iii) The shadow
...
injection as a statement about distinct classes) and the binomial
sandwich of Theorem~B are thus machine-verified, while the entropy limit
...
independent computations described above. The three core files use no library at all and can be
