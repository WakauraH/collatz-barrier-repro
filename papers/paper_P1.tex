...
(the climbing towers $-1\bmod 2^m$, the affine identity, the collapse and
persistence lemmas behind the robustness theorem, and the rotation lemma)
are machine-verified in Lean~4 from the standard axioms. We
...
\item[(iv)] \emph{Machine verification}: the core arithmetic lemmas ---
  ...
  remainder bound, both halves of the adaptive collapse lemma, the
  persistence step behind Theorem~A$'$, and the rotation lemma behind
  Theorem~B --- are verified in Lean~4 from the standard axioms alone
